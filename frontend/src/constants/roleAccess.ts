...
export const FEATURE_CATALOG: FeatureDef[] = [
  ...
  { id: 'communaute', label: 'Communauté CEDJ', kind: 'voir' },
...
export const NAV_FALLBACK: NavItemDef[] = [
  ...
  { page: 'communaute', to: '/dashboard/communaute', label: 'Communauté CEDJ' },
...
export const DEFAULT_FEATURES_BY_ROLE: Record<Role, FeatureId[]> = {
  DIRECTEUR: [
    'home', 'centres', 'formateurs', 'eleves', 'sessions', 'formations', 'journal-activite', 'transactions', 'rapports',
  ...
  COORDINATEUR: [
    'home', 'mes-centres', 'eleves', 'formations', 'ressources', 'communaute', 'profils-enfants',
    'signalements', 'rapports', 'profil', 'edit_centre_location', 'create_eleve', 'manage_signalements',
  ],
  RESPONSABLE_CLUSTER: [
    'home', 'mes-centres', 'eleves', 'sessions', 'formations', 'ressources', 'communaute', 'profils-enfants',
    'signalements', 'rapports', 'profil', 'edit_centre_location', 'create_eleve', 'manage_signalements',
  ],
  COMPTABLE: [
...
export const ROLE_ACCESS_SUMMARY: Record<Role, string> = {
  ...
  FORMATEUR: 'Un ou plusieurs centres assignés : élèves, séances, modules, ressources, communauté, profils enfants, paiements et rapports.',
  COORDINATEUR: 'Son centre uniquement : élèves, modules, ressources, communauté, profils enfants, signalements, rapports.',
  RESPONSABLE_CLUSTER: 'Tous les centres de son cluster : élèves, séances, modules, signalements, rapports, localisation.',
  COMPTABLE: 'Saisie des transactions hors app, justificatifs, rapports financiers, contrôle de gestion.',
  STAFF_NEHEMIAH: 'Ressources internes et communauté CEDJ.',
  ANIMATEUR: 'Ressources internes et communauté CEDJ.',
  PARENT: 'Uniquement le suivi de son enfant. Connexion par matricule.',
  BENEVOLE: 'Communauté CEDJ uniquement.',
  PARTICIPANT: 'Communauté CEDJ uniquement.',
};
